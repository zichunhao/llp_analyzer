...
python3 ${{MAINDIR}}/convertListMerge.py -i ${{PATH_NANOAODS}}
xrdcp -f ${{PATH_NTUPLES}} ntupler.root
./MergeNtuples ntupler.root local_list.txt merge_displacedJetMuon_ntupler_2023{run_num}_Muon{muon_num}.root ""
echo "Inside $MAINDIR:"
ls -lah
